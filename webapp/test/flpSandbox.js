		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "webpage",
									"targetURL": "#comappfirstui5proj-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappfirstui5proj-display": {
								"semanticObject": "comappfirstui5proj",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.firstui5proj",
									"url": sap.ui.require.toUrl("com/app/firstui5proj")
								}
							}
						}
					}
